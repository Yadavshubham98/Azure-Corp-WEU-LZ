...
azure_vault_url = "https://corpakvweupzcc01.vault.azure.net/"
...
cc_vm_managed_identity_name = "corp-mi-weu-prod-zcc"

# 5. Provide the existing Resource Group of the Azure Managed Identity name to attach to the CC VM. E.g. cloud_connector_rg_1

cc_vm_managed_identity_resource_group = "corp-rg-weu-prod-shared-connectivity-zcc-network"
...
network_address_space = "10.251.90.0/23"
...
cc_subnets = ["10.251.90.0/26", "10.251.90.64/26", "10.251.90.128/26"]
